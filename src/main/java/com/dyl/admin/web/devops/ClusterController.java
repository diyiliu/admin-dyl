package com.dyl.admin.web.devops;

import com.dyl.admin.support.model.ExecuteOut;
import com.dyl.admin.support.util.RemoteUtil;
import com.dyl.admin.web.deploy.dto.Deploy;
import com.dyl.admin.web.deploy.facade.DeployJpa;
import com.dyl.admin.web.devops.dto.DevNode;
import com.dyl.admin.web.devops.dto.NodeStatus;
import com.dyl.admin.web.devops.facade.DevNodeJpa;
import com.dyl.admin.web.devops.facade.NodeStatusJpa;
...
public class ClusterController {
    ...
    public Integer modify(DevNode devNode) throws Exception {
        ...
        // SCP 远程拷贝
        if (temp.getCheckOn() != null && temp.getCheckOn() == 1) {
            remoteCopy(temp);
        } else {
